...
class InceptionV1Builder:

    def __init__(self, input_shape=(224, 224, 3), output_units=1000, init_kernel=(7, 7), init_strides=(2, 2),
                 init_filters=64,
    ...
    def _auxiliary(self, name="auxiliary_1"):
        ...
        def f(input_x):
            ...
            return Dense(units=self.output_units, activation="softmax", kernel_initializer=self.initializer, name=name)(
                x)
    ...
    def _inception_block(self, _1x1=64, _3x3r=96, _3x3=128, _5x5r=16, _5x5=32, _maxpool=32, name="inception3a"):
        ...
        def f(input_x):
            ...
            brancemaxpool = self._cn_relu(filters=_maxpool, kernel_size=(1, 1), strides=(1, 1), padding="same")(
                brancemaxpool)
    ...
    def build_inception(self):
        ...
        x = self._cn_relu(filters=self.init_filters, kernel_size=self.init_kernel, strides=self.init_strides,
        ...
        # inception(4e)
        x = self._inception_block(_1x1=256, _3x3r=160, _3x3=320, _5x5r=32, _5x5=128, _maxpool=128, name="inception4e")(
            x)

        x = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), padding="same")(x)

        # inception(5a)
        x = self._inception_block(_1x1=256, _3x3r=160, _3x3=320, _5x5r=32, _5x5=128, _maxpool=128, name="inception5a")(
            x)
        # inception(5b)
        x = self._inception_block(_1x1=384, _3x3r=192, _3x3=384, _5x5r=48, _5x5=128, _maxpool=128, name="inception5b")(
            x)
        ...
        output_x = Dense(units=self.output_units, activation="softmax", kernel_initializer=self.initializer,
                         name="main_output")(x)
...
inception_builder = InceptionV1Builder()
